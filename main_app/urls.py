...
urlpatterns = [
    ...
    path('exhibit/<int:pk>/', views.text_exhibit, name='text_exhibit'),
    path('exhibit/create/', views.TextExhibitCreate.as_view(), name='text_exhibit_create'),
    path('exhibit/<int:pk>/update/', views.TextExhibitUpdate.as_view(), name='text_exhibit_update'),
    path('exhibit/<int:pk>/delete/', views.TextExhibitDelete.as_view(), name='text_exhibit_delete'),
    path('exhibit/upload/', views.upload, name='upload'),
    path('photo/<int:pk>/', views.photo_exhibit, name='photo_exhibit'),

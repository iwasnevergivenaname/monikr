...
urlpatterns = [
    ...
    path('artist/<int:pk>/commission/<int:id>/update/', views.CommissionUpdate.as_view(), name='commission_update'),
    path('artist/<int:pk>/contact/create/', views.ContactCreate.as_view(), name='contact_create'),
    path('artist/<int:pk>/contact/<int:id>/update/', views.ContactUpdate.as_view(), name='contact_update'),
